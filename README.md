...
## fully-mqtt adapter for ioBroker

Control Fully Kiosk Browser
...
1. Create a new repository on GitHub with the name `ioBroker.fully-mqtt`
...
1. Link your local repository with the one on GitHub:  
    ```bash
    git remote add origin https://github.com/Acgua/ioBroker.fully-mqtt
    ```
...
1. Push all files to the GitHub repo:  
    ...
    ```
1. Add a new secret under https://github.com/Acgua/ioBroker.fully-mqtt/settings/secrets. It must be named `AUTO_MERGE_TOKEN` and contain a personal access token with push access to the repository, e.g. yours. You can create a new token under https://github.com/settings/tokens.
...
The ioBroker.admin interface will then be available at http://localhost:8093/
